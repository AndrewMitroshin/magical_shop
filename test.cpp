...
int main()
	{
		flying_shop Heaven(50, 25, 125, 75, 250, 125); // наследник класса magical_shop
		Heaven.shop_sellers(); //виртуальный метод
		magical_shop::color_shop("blue"); // вложенный класс
		cout << endl;
